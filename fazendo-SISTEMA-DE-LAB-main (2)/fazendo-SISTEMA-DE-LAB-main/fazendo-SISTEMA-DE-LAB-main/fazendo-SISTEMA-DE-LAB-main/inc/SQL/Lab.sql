...
create table labs (
  cd_lab int primary key auto_increment not null,
  nr_lab int not null
);

create table professores (
  cd_professor int primary key auto_increment not null,
...
create table turmas (
  cd_turma int primary key auto_increment not null,
  nm_turma varchar(100) not null,
  ds_turma varchar(100)
);

create table reservas (
  cd_reserva int primary key auto_increment not null,
  ...
  foreign key (id_lab) references labs (cd_lab)
);
