...
<body>
   ...
   <div class="sidebar">
    <ul class="nav flex-column pt-3">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $pagina == 'professores.php' ? 'active' : '' ?>" href="professores.php">
                Professores
            </a>
        </li>
    </ul>
                                    ...
                                    <tbody>
                                        <?php while ($linha = mysqli_fetch_assoc($resultado)): ?>
                                            <tr>
                                                <td>
                                                    <span class="badge-id">
                                                        <?= htmlspecialchars($linha['cd_professor']) ?>
                                                    </span>
                                                </td>
                                                <td class="fw-medium">
                                                    <?= htmlspecialchars($linha['nm_professor']) ?>
                                                </td>
                                                <td>
                                                    <?= htmlspecialchars($linha['ds_email']) ?>
                                                </td>
                                                <td>
                                                    <?= htmlspecialchars($linha['ds_matricula']) ?>
                                                </td>
                                                <td class="text-center">
                                                    <a href="editar_prof.php?cd=<?= $linha['cd_professor'] ?>" 
                                                       class="btn btn-outline-primary btn-action me-1">
                                                        Editar
                                                    </a>
                                                    <a href="excluir_prof.php?cd=<?= $linha['cd_professor'] ?>" 
