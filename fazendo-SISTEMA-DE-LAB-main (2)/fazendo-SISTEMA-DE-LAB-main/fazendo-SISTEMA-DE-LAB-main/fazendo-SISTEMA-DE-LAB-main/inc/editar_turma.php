...
$sql = "SELECT * FROM turmas WHERE cd_turma = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE turmas SET nm_turma = ?, ds_turma = ? WHERE cd_turma = ?";
    $stmt = mysqli_prepare($conexao, $sql);
    mysqli_stmt_bind_param($stmt, "ssi", $nm_turma, $ds_turma, $id);

    if (mysqli_stmt_execute($stmt)) {
        header("Location: turma.php?msg=editado");
        exit;
    } else {
                        ...
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       name="nm_turma" 
                                       class="form-control" 
                                       value="<?= htmlspecialchars($lab['nm_turma']) ?>" 
                                       required>
                                ...
                                <input type="text" 
                                       name="ds_turma" 
                                       class="form-control" 
                                       value="<?= htmlspecialchars($lab['ds_turma']) ?>" 
                                       required>
                            </div>
