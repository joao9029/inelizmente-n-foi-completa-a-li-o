...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $ds_matricula = $_POST['ds_matricula'] ?? '';

    $sql = "UPDATE professores SET nm_professor = ?, ds_email = ?, ds_matricula = ? WHERE cd_professor = ?";
    $stmt = mysqli_prepare($conexao, $sql);
    mysqli_stmt_bind_param($stmt, "sssi", $nm_professor, $ds_email, $ds_matricula, $id);
                        ...
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       name="nm_professor" 
                                       class="form-control" 
                                       value="<?= htmlspecialchars($lab['nm_professor']) ?>" 
                                       required>

                                <label class="form-label fw-semibold">descrição da turma</label>
                                <input type="text" 
                                       name="ds_email" 
                                       class="form-control" 
                                       value="<?= htmlspecialchars($lab['ds_email']) ?>" 
                                       required>
                                ...
                                <input type="text" 
                                       name="ds_matricula" 
                                       class="form-control" 
                                       value="<?= htmlspecialchars($lab['ds_matricula']) ?>" 
                                       required>
                            </div>
