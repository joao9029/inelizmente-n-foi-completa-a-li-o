...
<body>
    ...
    <div class="sidebar">
        <ul class="nav flex-column pt-3">
            <li class="nav-item">
                <a class="nav-link <?= $pagina == 'index.php' ? 'active' : '' ?>" href="index.php">
                    Laboratórios
                </a>
            </li>
            <li class="nav-item">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header text-white d-flex justify-content-between align-items-center">
                        ...
                        <a href="cadastrar_lab.php" class="btn btn-novo">
                             Novo Laboratório
                        </a>
                    </div>
                                        ...
                                        <?php while ($linha = mysqli_fetch_assoc($resultado)): ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="editar.php?cd=<?= $linha['cd_lab'] ?>" 
                                                       class="btn btn-outline-primary btn-action me-1">
                                                        Editar
                                                    </a>
                                                    <a href="excluir.php?cd=<?= $linha['cd_lab'] ?>" 
