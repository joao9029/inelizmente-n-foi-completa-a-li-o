...
<body>
  ...
  <div class="sidebar">
    <ul class="nav flex-column pt-3">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $pagina == 'turma.php' ? 'active' : '' ?>" href="turma.php">
                Turmas
            </a>
        </li>
        <li class="nav-item">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header text-white d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Lista das turmas</h4>
                                    ...
                                    <tbody>
                                        <?php while ($linha = mysqli_fetch_assoc($resultado)): ?>
                                            <tr>
                                                <td>
                                                    <span class="badge-id">
                                                        #<?= htmlspecialchars($linha['cd_turma']) ?>
                                                    </span>
                                                </td>
                                                <td class="fw-medium">
                                                    <?= htmlspecialchars($linha['nm_turma']) ?>
                                                </td>
                                                <td>
                                                    <?= htmlspecialchars($linha['ds_turma']) ?>
                                                </td>
                                               
                                                <td class="text-center">
                                                    <a href="editar_turma.php?cd=<?= $linha['cd_turma'] ?>" 
                                                       class="btn btn-outline-primary btn-action me-1">
                                                        Editar
                                                    </a>
                                                    <a href="excluir_turma.php?cd=<?= $linha['cd_turma'] ?>" 
